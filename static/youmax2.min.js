...
(function ($) {
	...
	loadYoumax = function() {	
		...
		// Original previo ajustes 2024
		// $('#youmax').append('<div id="youmax-tabs"><span id="featured_" class="youmax-tab">Destacado</span><span id="uploads_" class="youmax-tab">Videos cargados</span><span id="playlists_" class="youmax-tab">Listas de reproducción</span></div>');
		$('#youmax').append('<div id="youmax-tabs"><span id="playlists_" class="youmax-tab">Listas de reproducción</span></div>');
		
		$('#youmax').append('<div id="youmax-encloser"><iframe id="youmax-video" width="'+(youmaxWidgetWidth-2)+'" height="'+(youmaxWidgetWidth/youmax_global_options.youtubeVideoAspectRatio)+'" src="" frameborder="0" allowfullscreen></iframe><div id="youmax-video-list-div"></div><div id="youmax-load-more-div">CARGAR MÁS</div></div>');
	...
	resetLoadMoreButton = function() {
		...
		$youmaxLoadMoreDiv.text('CARGAR MÁS');
	},
		...
		*/
		...
		$('#youmax-load-more-div').click(function(){
			...
			if(null!=nextPageToken && nextPageToken!="undefined" && nextPageToken!="") {
				...
				$youmaxLoadMoreDiv.html('TODO HA SIDO CARGADO');
			}
